...
typedef NSString * CALayerContentsGravity NS_TYPED_ENUM API_AVAILABLE(macos(10.5), ios(2.0), tvos(9.0));
typedef NSString * CALayerContentsFormat NS_TYPED_ENUM API_AVAILABLE(macos(10.12), ios(10.0), tvos(10.0));
typedef NSString * CALayerContentsFilter NS_TYPED_ENUM API_AVAILABLE(macos(10.5), ios(2.0), tvos(9.0));
typedef NSString * CALayerCornerCurve NS_TYPED_ENUM API_AVAILABLE(macos(10.15), ios(13.0), tvos(13.0));
...
API_AVAILABLE(macos(10.5), ios(2.0), tvos(9.0))
...
API_AVAILABLE(macos(10.7), ios(4.0), tvos(9.0));
...
API_AVAILABLE(macos(10.8), ios(6.0), tvos(9.0));
...
API_AVAILABLE(macos(10.6), ios(3.0), tvos(9.0));
